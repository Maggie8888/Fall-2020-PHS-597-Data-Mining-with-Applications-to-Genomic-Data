---
title: "PHS597:Homework 3"
author: "menglu liang"
date: "09/17/2020"
output: pdf_document
latex_engine: xelatex
header-includes: \usepackage{table,tabular,ragged2e,booktabs,caption,fontenc,inputenc,amsmath, amsthm, amssymb, amsfonts}
---

```{r, include=FALSE}
rm(list=ls())
#setwd('~/Dropbox/biostatistics_PSU/PHS528/Ex/')
library(ggplot2)
library(readxl)
library(dplyr)         
library(tidyr)  
